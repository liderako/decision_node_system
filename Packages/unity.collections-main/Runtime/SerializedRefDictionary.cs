...
namespace Dythervin.Collections
{
    ...
    [Serializable]
    public class SerializedRefDictionary<TKey, TValue> : Dictionary<TKey, TValue>,
    ...
    [Serializable]
    public class SerializedRefDictionaryWrapped<TKey, TValue> : ISerializationCallbackReceiver,
